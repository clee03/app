...
<!-- 
 ...
 -->
  <div class="section get-help hero">
    <div class="container">
      <h3 class="section-heading">Hello Fortune</h3>
      <a class="button button-primary" href="" id="bs">get the bullshit</a>
      <p class="section-description">Some bullshit goes here. Skeleton images sit easily in grid with .u-max-full-width class. I suggest exploring solution to serving different images based on device size.</p>
    </div>
  </div>
